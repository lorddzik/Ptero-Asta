...
const StartupContainer = () => {
    ...
    return !data ? (
        ...
        <ServerContentBlock title={'Startup Settings'} showFlashKey={'startup:image'}>
            <div css={tw`md:flex`}>
                <TitledGreyBox title={'Startup Command'} css={tw`flex-1`}>
                    <div css={tw`px-1 py-2`}>
                        <p
                            css={tw`font-mono rounded py-2.5 px-4 break-all select-all`}
                            style={{
                ...
                <TitledGreyBox title={'Docker Image'} css={tw`flex-1 lg:flex-none lg:w-1/3 mt-8 md:mt-0 md:ml-6`}>
                    {Object.keys(data.dockerImages).length > 1 && !isCustomImage ? (
                        <>
                            ...
                            <p css={tw`text-xs mt-2`} style={{ color: 'var(--neo-text-muted)' }}>
            ...
            <h3 css={tw`mt-10 mb-4 text-2xl font-extrabold tracking-wide uppercase`} style={{ color: 'var(--neo-text)' }}>Variables</h3>
